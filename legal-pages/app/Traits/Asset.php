...
trait Asset {
	 ...
	 * @param string $ver       Script version, defaults to the constant LEGAL_PAGES_VERSION.
	 ...
	 * @param string $ver    Style version, defaults to the constant LEGAL_PAGES_VERSION.
	 ...
	 * Otherwise, returns the specified version or the LEGAL_PAGES_VERSION constant if no version is provided.
	 *
