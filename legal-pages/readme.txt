...
* Fix: Shortcode issue
= 1.6.1 =
* Add: Updated WordPress org assets with new screenshots
= 1.6.0 =
...
* Fix: Miscellaneous settings issue
= 1.4.3 =
* Fixed: Security Issue
= 1.4.2 =
* Fixed: Security Issue
...
* Add: Shortcode
* Fix: Terms of new template issue
= 1.0.6 =
...
* Fixed: Design issue
= 1.0.1 =
* Removed dumped testing data when creating legal page template
